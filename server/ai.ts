  ...
  try {
    const response = await axios.post(
      'https://openrouter.ai/api/v1/chat/completions',
      {
        model: model,
        messages: [
          { role: 'system', content: 'You are a helpful YouTube content analysis assistant.' },
...
5. Specific actionable suggestions to improve ranking
6. A list of 5 alternative title suggestions that would perform better
